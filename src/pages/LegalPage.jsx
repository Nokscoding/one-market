...
const SECTIONS = {
  conditions: {
    ...
    blocks: [
      ...
      ['5. Paiement à la livraison', 'Le paiement à la livraison peut être proposé lorsque ce mode est actif. Le client règle le montant prévu auprès du livreur au moment de recevoir la commande. Aucun paiement ne doit être considéré comme encaissé tant qu’il n’a pas été confirmé dans One Market.'],
  ...
  vendeurs: {
    ...
    blocks: [
      ...
      ['Commission One Market', 'Sauf accord spécifique, One Market applique une commission générale de 30 % sur le montant des produits vendus via la plateforme. Une boutique peut bénéficier d’un taux différent lorsqu’un accord spécifique est enregistré par One Market. Les frais de livraison ne sont pas automatiquement inclus dans la base de calcul de la commission produit.'],
      ['Versements vendeur', 'Le montant destiné au vendeur correspond au produit de ses ventes après application de la commission et des éventuels ajustements autorisés. Un montant n’est considéré comme payable au vendeur que lorsque les conditions de règlement prévues par One Market sont remplies, notamment la livraison et la confirmation du paiement lorsque cela s’applique. L’historique des versements reste consultable dans l’espace vendeur.'],
      ...
      ['Commandes et stock', 'Le vendeur doit maintenir son stock à jour, traiter les commandes dans des délais raisonnables et signaler rapidement toute impossibilité de fournir un produit. Le vendeur peut gérer la préparation de sa sous-commande, mais les étapes de livraison et d’encaissement qui relèvent de One Market ou de ses partenaires ne doivent pas être déclarées arbitrairement par la boutique.'],
