...
function MiniProduct({ product }) {
  return <Link to={`/product/${product.id}`} className="mini-product"><div className="mini-product-image"><SmartImage src={product.image} alt={product.name} fallback="OM" fit="contain" /></div><span>{product.name}</span></Link>
}
